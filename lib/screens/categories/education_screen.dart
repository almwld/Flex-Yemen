...
class education_Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('education'), centerTitle: true, elevation: 0),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('قسم education', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppTheme.getTextColor(context))),
