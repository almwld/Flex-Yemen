...
class music_Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('music'), centerTitle: true, elevation: 0),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('قسم music', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppTheme.getTextColor(context))),
