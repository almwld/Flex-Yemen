...
class stationery_Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('stationery'), centerTitle: true, elevation: 0),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('قسم stationery', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppTheme.getTextColor(context))),
