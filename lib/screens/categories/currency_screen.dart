...
class currency_Screen extends StatelessWidget {
  const currency_Screen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('currency'), centerTitle: true, elevation: 0),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('قسم currency', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppTheme.getTextColor(context))),
